...
const SignUp  = () => {
  ...
  const { signUpUserWithEmailAndPassword, putDataIntoDatabase, signInWithGoogle, signInWithGithub, signInWithTwitter } = useFirebase();
  ...
  const handleGithubSignIn = async () => {
    try {
      ...
      toast.success('Sign in with Github successful!', {position: 'top-left'});
    } catch (error) {
      console.error("Error signing in with Github:", error);
      toast.error('Failed to sign in with Github. Please try again.', {position: 'top-center'});
    }
  };
  ...
  const handleTwitterSignIn = async () => {
    try {
      ...
      toast.success('Sign in with Twitter successful!', {position: 'top-left'});
      navigate('/');
    } catch (error) {
      console.error("Error signing in with Twitter:", error);
      toast.error('Failed to sign in with Twitter. Please try again.', {position: 'top-center'});
    }
  };
